      ...
      <aside className={`sidebar ${isMobileOpen ? 'sidebar--mobile-open' : ''}`}>
        ...
        <nav className="sidebar__nav">
          ...
          <NavLink
            ...
            onClick={closeMobile}
          >
            <span className="sidebar__link-icon"><IconPackage /></span>
          ...
          <NavLink
            ...
            onClick={closeMobile}
          >
            <span className="sidebar__link-icon"><IconChart /></span>
          ...
          <NavLink
            ...
            onClick={closeMobile}
          >
            <span className="sidebar__link-icon"><IconArchive /></span>
            <span className="sidebar__link-text">Archivo</span>
          </NavLink>
        </nav>
        ...
        <div className="sidebar__footer">
          ...
          <NavLink
            ...
            onClick={closeMobile}
          >
            <span className="sidebar__link-icon"><IconSupport /></span>
